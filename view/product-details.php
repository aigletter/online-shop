...
<div style="width: 80%; margin-left: 10%">
    <div style="padding-bottom: 20px">
        ...
        <div style="width: 50%; margin-left: 2%; display: inline-block; padding-bottom: 20px;">
            <div>
            ...
            <div>
                <a href="/category/view/id/<?php echo $product['category_id']?>"><?php echo $product['category_name']?></a>
            </div>
            <div>
